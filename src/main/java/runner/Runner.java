...
public class Runner {
    public static void main(String[] args) {
        String stringToParse = "Пузырь Алькубьерре — идея, основанная на верном решении уравнений Эйнштейна. " +
                "Предложенная мексиканским физиком-теоретиком Мигелем Алькубьерре.    \n\tВ которой космический аппарат " +
                "может достичь сверхсветовой скорости.\t\nДвижение выше скорости света невозможно для объектов в " +
                "нормальном пространстве-времени.";
